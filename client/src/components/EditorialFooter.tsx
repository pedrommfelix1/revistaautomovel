  ...
  return (
    <footer className="mt-20 bg-black text-white sm:mt-32">
      <div className="editorial-shell grid gap-10 py-12 sm:grid-cols-[1.3fr_1fr] sm:py-16">
        <div>
          <div className="mb-6 flex items-center gap-3"><span className="h-4 w-4 bg-[#f0372f]" /><span className="text-3xl font-black uppercase tracking-[-0.08em]">Auto Turbo</span></div>
