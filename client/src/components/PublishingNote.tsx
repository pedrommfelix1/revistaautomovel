...
export function PublishingNote({ className = "" }: { className?: string }) {
  return (
    <p data-testid="publishing-note" className={`text-right font-mono text-[11px] font-bold uppercase leading-snug tracking-[0.1em] text-neutral-500 sm:text-left sm:text-xs ${className}`}>
