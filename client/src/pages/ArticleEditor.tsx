...
export default function ArticleEditor() {
  ...
  async function handleImageUpload(event: ChangeEvent<HTMLInputElement>, target: "cover" | "gallery" | "social") {
    ...
    if (target === "gallery" && images.length >= 10) { toast.error("Cada artigo suporta até 10 imagens na galeria. Use a multimédia para mais fotografias."); return; }
    setUploading(true);
    try {
