  ...
  return (
    <div className="flex min-h-screen flex-col bg-white">
      ...
      <main className="editorial-shell flex-1 py-11 sm:py-16">
        ...
        <p className="mt-4 max-w-xl text-sm leading-relaxed text-neutral-600">Um arquivo fotográfico do Auto Turbo, independente dos artigos — até cem imagens editoriais.</p>
        {isLoading ? (
